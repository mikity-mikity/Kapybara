...
namespace Kapybara3D {
	...
	public ref class managedElement
		...
		public:
			...
			int elemDim;
		private:
			Kapybara3D::Materials::material ^constitutive;
		public:
			void initialize(int _nNode,int _elemDim,int _nIntPoint,Kapybara3D::Elements::iElement *e)
			{
				_elem=e;
				nNode=_nNode;
				elemDim=_elemDim;
		...
		public:
			...
			managedElement(int _nNode,int _elemDim,int _nIntPoint,Kapybara3D::Elements::iElement *e)
			{
				initialize(_nNode,_elemDim,_nIntPoint,e);
			}
			managedElement(array<int,1> ^_index,int _nNode,int _elemDim,int _nIntPoint,Kapybara3D::Elements::iElement *e)
			{
				initialize(_nNode,_elemDim,_nIntPoint,e);
			...
			void setMaterial(Kapybara3D::Materials::material ^_m)
			{
				constitutive=_m;
			}
		...
		public ref class S2D1:public managedElement
		{
		public:
			S2D1():managedElement(2,1,1,_elem=new simplexElement<2,1>())
			{
			}
			S2D1(array<int,1> ^_index):managedElement(_index,2,1,1,_elem=new simplexElement<2,1>())
			{
			}
		...
		public ref class S3D2:public managedElement
		{
		public:
			S3D2():managedElement(3,2,1,new simplexElement<3,2>())
			{
			}
			S3D2(array<int,1> ^_index):managedElement(_index,3,2,1,_elem=new simplexElement<3,2>())
			{
			}
			~S3D2()
			{
		...
		public ref class S4D3:public managedElement
		{
		public:
			S4D3():managedElement(4,3,1,new simplexElement<4,3>())
			{
			}
			S4D3(array<int,1> ^_index):managedElement(_index,4,3,1,new simplexElement<4,3>())
			{
			}
			~S4D3()
			{
		...
		public ref class I2D1:public managedElement
		{
		public:
			I2D1():managedElement(2,1,3,new isoparametricElement<2,1,3>())
			{
			}
			I2D1(array<int,1> ^_index):managedElement(_index,2,1,3,new isoparametricElement<2,1,3>())
			{
			}
			~I2D1()
			{
		...
		public ref class I4D2:public managedElement
		{
		public:
			I4D2():managedElement(4,2,9,new isoparametricElement<4,2,9>())
			{
			}
			I4D2(array<int,1> ^_index):managedElement(_index,4,2,9,new isoparametricElement<4,2,9>())
			{
			}
		...
		public ref class I8D3:public managedElement
		{
		public:
			I8D3():managedElement(8,3,27,new isoparametricElement<8,3,27>())
			{
			}
			I8D3(array<int,1> ^_index):managedElement(_index,8,3,27,new isoparametricElement<8,3,27>())
			{
			}
			~I8D3()
			{
